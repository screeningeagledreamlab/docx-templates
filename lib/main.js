            ...
            switch (_h.label) {
                case 0:
                    ...
                    createOptions = {
                        ...
                        imageConcurrency: (_g = options.imageConcurrency) !== null && _g !== void 0 ? _g : 10,
                    };
                    xmlOptions = {
                        literalXmlDelimiter: literalXmlDelimiter,
                ...
                case 1:
                    _a = _h.sent(), jsTemplate = _a.jsTemplate, mainDocument = _a.mainDocument, zip = _a.zip, contentTypes = _a.contentTypes;
