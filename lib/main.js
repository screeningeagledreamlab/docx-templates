            ...
            switch (_g.label) {
                case 0:
                    ...
                    createOptions = {
                        ...
                        allowNestedIf: (_f = options.allowNestedIf) !== null && _f !== void 0 ? _f : false,
                ...
                case 1:
                    _a = _g.sent(), jsTemplate = _a.jsTemplate, mainDocument = _a.mainDocument, zip = _a.zip, contentTypes = _a.contentTypes;
                ...
                case 7:
                    ...
                    if (!(createOptions.imageConcurrency != null)) return [3 /*break*/, 9];
                    debug_1.logger.debug('Resolving pending image downloads in parallel...');
                    return [4 /*yield*/, (0, processTemplate_1.resolvePendingImages)(ctx, createOptions.imageConcurrency)];
                case 8:
                    imageErrors = _g.sent();
                ...
                case 12:
                    ...
                    _g.label = 13;
                case 13:
                    if (!(_i < prepped_secondaries_1.length)) return [3 /*break*/, 21];
                ...
                case 14:
                    ...
                    if (!(createOptions.imageConcurrency != null)) return [3 /*break*/, 16];
                    return [4 /*yield*/, (0, processTemplate_1.resolvePendingImages)(ctx, createOptions.imageConcurrency)];
                case 15:
                    imageErrors = _g.sent();
                    if (imageErrors.length > 0)
