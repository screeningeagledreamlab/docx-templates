...
['noSandbox', 'sandbox'].forEach(function (sbStatus) {
    ...
    describe("".concat(sbStatus), function () {
        describe('Template processing', function () {
            ...
            it('Nested IF statements on same line with allowNestedIf: true', function () { return __awaiter(void 0, void 0, void 0, function () {
                var template, result;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, fs_1.default.promises.readFile(path_1.default.join(__dirname, 'fixtures', 'ifStatementsOnSameLineSkipValidation.docx'))];
                        case 1:
                            template = _a.sent();
                            return [4 /*yield*/, (0, index_1.createReport)({
                                    noSandbox: noSandbox,
            ...
            it('IF-in-table: preserves cell when left IF evaluates to false (regression test for v4.12.0 bug)', function () { return __awaiter(void 0, void 0, void 0, function () {
                var template, result;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, fs_1.default.promises.readFile(path_1.default.join(__dirname, 'fixtures', 'IF-in-table.docx'))];
                        case 1:
                            template = _a.sent();
                            return [4 /*yield*/, (0, index_1.createReport)({
                                    noSandbox: noSandbox,
                        ...
                        case 2:
                            ...
                            //   data: {
                            //     // leftCol is missing (falsy), rightCol has value (truthy)
                            //     v: [{ rightCol: 'value', rightContent: 'Right Content' }],
                            //   },
                            //   cmdDelimiter: ['{{', '}}'],
                            //   additionalJsContext: {
                            //     T: (key: string) => key,
                            //   },
                            // });
                            // fs.writeFileSync('./out.docx', result2);
            ...
            it('IF-in-table: preserves cell when right IF evaluates to false', function () { return __awaiter(void 0, void 0, void 0, function () {
                var template, result;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, fs_1.default.promises.readFile(path_1.default.join(__dirname, 'fixtures', 'IF-in-table.docx'))];
            ...
            it('IF-in-table: preserves cells when both IF conditions are true', function () { return __awaiter(void 0, void 0, void 0, function () {
                var template, result;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, fs_1.default.promises.readFile(path_1.default.join(__dirname, 'fixtures', 'IF-in-table.docx'))];
