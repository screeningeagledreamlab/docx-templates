...
var processCmd = function (data, node, ctx) { return __awaiter(void 0, void 0, void 0, function () {
    var cmd, _a, cmdName, cmdRest, aliasMatch, aliasName, fullCmd, result, nerr, str, literalXmlDelimiter, splitByLineBreak, LINE_BREAK, END_OF_TEXT, START_OF_TEXT, id, relId, pendingDownload, isInsideLoop, capturedVars_1, capturedIdx_1, img, pars, html, err_1;
    var _b;
    return __generator(this, function (_c) {
        switch (_c.label) {
            case 0:
            ...
            case 15:
                ...
                pendingDownload.fetchImage = function () {
                    ...
                    if (capturedVars_1 !== null) {
                        ...
                        try {
                            return (0, jsSandbox_1.runUserJsAndGetRaw)(data, cmdRest, ctx);
                        }
                        finally {
