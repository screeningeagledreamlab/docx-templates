...
var processCmd = function (data, node, ctx) { return __awaiter(void 0, void 0, void 0, function () {
    var cmd, _a, cmdName, cmdRest, aliasMatch, aliasName, fullCmd, result, nerr, str, literalXmlDelimiter, splitByLineBreak, LINE_BREAK, END_OF_TEXT, START_OF_TEXT, id, relId, pendingDownload, frozenSandbox_1, curLoop, img, pars, html, err_1;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
            ...
            case 15:
                ...
                frozenSandbox_1 = __assign(__assign(__assign({ __code__: undefined, __result__: undefined }, (ctx.jsSandbox || {})), data), ctx.options.additionalJsContext);
                curLoop = (0, reportUtils_1.getCurLoop)(ctx);
                if (curLoop)
                    frozenSandbox_1.$idx = curLoop.idx;
                Object.keys(ctx.vars).forEach(function (varName) {
                    frozenSandbox_1["$".concat(varName)] = ctx.vars[varName];
                });
                pendingDownload.frozenSandbox = frozenSandbox_1;
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    ...
                    return [4 /*yield*/, Promise.allSettled(pendingDownloads.map(function (pd) {
                            return limit(function () { return (0, jsSandbox_1.runUserJsAndGetRaw)(undefined, pd.code, ctx, pd.frozenSandbox); });
                        }))];
                case 1:
                    results = _b.sent();
                    i = 0;
