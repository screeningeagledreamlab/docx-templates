...
function runUserJsAndGetRaw(data, code, ctx, sandboxOverride, frozenCtx) {
            ...
            switch (_b.label) {
                case 0:
                    sandbox = sandboxOverride
                        ? __assign(__assign({}, sandboxOverride), { __code__: code, __result__: undefined }) : __assign(__assign(__assign(__assign({}, (ctx.jsSandbox || {})), { __code__: code, __result__: undefined }), data), ctx.options.additionalJsContext);
                ...
                case 1:
                    ...
                    temp = ctx.options.runJs({ sandbox: sandbox, ctx: frozenCtx !== null && frozenCtx !== void 0 ? frozenCtx : ctx });
